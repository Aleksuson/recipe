package com.aleksuson.recipe.bootstrap;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        log.debug(LocalDate.now() + "Starting to load bootstrap data");
        recipeRepository.saveAll(getRecipes());
        log.debug(LocalDate.now() + "Bootstrap data loaded");
    }
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        log.debug(LocalDate.now() + " Getting UOMs");
        ...
        //get optionals
        log.debug(LocalDate.now() + "Getting optionals");
        ...
        //get Categories
        log.debug(LocalDate.now() + "Getting Categories");
        ...
        //Yummy Guac
        log.debug(LocalDate.now() + " Perfect Guacamole recipe");
        ...
        //Yummy Tacos
        log.debug(LocalDate.now() + " Yummy Tacos recipe");
